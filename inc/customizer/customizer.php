...
class Wortex_Customizer {
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'wortex_layout' , array(
			'default'     => 'boxed',
		...
		$wp_customize->add_setting( 'wortex_logo' , array(
			'default'     => '',
		...
		$wp_customize->add_setting( 'wortex_responsive_mode' , array(
			'default'     => 'on',
	...
	public static function customize_controls_scripts(){
		...
		wp_register_script(
			  ...
			  THEME_DIR_URI . '/inc/customizer/js/wortex-customizer-section.js',
