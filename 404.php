...
?><div id="page-title"><div class="container"><h2><?php _e('404: Page Not Found', 'wortex'); ?></h2></div></div><?php

?><div id="main-content" class="container"><div id="page-container" class="with-sidebar"><?php

	?><h2><?php _e('Page Not Found', 'wortex'); ?></h2><?php
	?><p><?php _e('What you are looking for isn\'t here...', 'wortex'); ?></p><?php
	?><p><?php _e('Maybe a search will help ?', 'wortex'); ?></p><?php
	get_search_form();
