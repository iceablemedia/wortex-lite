...
?><div id="main-content" class="container"><?php
	...
	$args = array(
		'before'           => '<br class="clear" /><div class="paged_nav">' . __('Pages:', 'wortex'),
		'after'            => '</div>',
		'link_before'      => '<span>',
		'link_after'       => '</span>',
	...
	if (has_tag()) the_tags('<div class="tags"><span class="the-tags">'.__('Tags', 'wortex').':</span>', '', '</div>');

				?></div></div><?php // end div post

				?><div class="article_nav"><?php
				if ("" != get_adjacent_post( false, "", false ) ): // Is there a previous post?
					?><div class="next navbutton"><?php next_post_link('%link', __('Next Post', 'wortex') . ' <i class="fa fa-angle-right"></i>'); ?></div><?php
				endif;
				if ("" != get_adjacent_post( false, "", true ) ): // Is there a next post?
					?><div class="previous navbutton"><?php  previous_post_link('%link', '<i class="fa fa-angle-left"></i> ' . __('Previous Post', 'wortex')); ?></div><?php
				endif;
			...
			if ( comments_open() || get_comments_number()!=0 ):
				...
				if ( is_attachment() ): // Use image navigation links on attachment pages
					...
					?><div class="previous"><?php previous_image_link(0, __("Previous Image", 'wortex') ); ?></div><?php 
					endif;
					if ( wortex_adjacent_image_link(true) ): // Is there a next image ?
					?><div class="next"><?php next_image_link(0, __("Next Image",'wortex') ); ?></div><?php
					endif;
